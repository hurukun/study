(function(a) {
    ...
    a.fn.prettyPhoto = function(e) {
        ...
        function o(b) {
            return b.match(/youtube\.com\/watch/i) ? "youtube" : b.match(/vimeo\.com/i) ? "vimeo" : b.match(/\b.mov\b/i) ? "quicktime" : b.match(/\b.mp4\b/i) ? "quicktime" : b.match(/\b.avi\b/i) ? "quicktime" : b.match(/\b.swf\b/i) ? "flash" : b.match(/\biframe=true\b/i) ? "iframe" : b.match(/\bajax=true\b/i) ? "ajax" : b.match(/\bcustom=true\b/i) ?
                "custom" : b.substr(0, 1) == "#" ? "inline" : "image"
        }
        function s() {
        ...
        e.keyboard_shortcuts && a(document).unbind("keydown.prettyphoto").bind("keydown.prettyphoto", function(b) {
            if (typeof $pp_pic_holder !=
                "undefined") if ($pp_pic_holder.is(":visible")) switch (b.keyCode) {
                case 37:
                    a.prettyPhoto.changePage("previous");
                    b.preventDefault();
                    break;
            ...
            $pp_pic_holder.fadeIn(function() {
                ...
                switch (o(pp_images[set_position])) {
                    ...
                    case "quicktime":
                        ...
                        toInject = settings.quicktime_markup.replace(/{width}/g, c.width).replace(/{height}/g, c.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, pp_images[set_position]).replace(/{autoplay}/g,
                        settings.autoplay);
                        break;
                    case "flash":
                        c = f(movie_width, movie_height);
